...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return PLAY_CLASS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return PAUSE_CLASS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return LOAD_CLASS; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return LOOP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return CIRCULATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return RANDOM; });


var PLAY_CLASS = 'pause';

var PAUSE_CLASS = 'play';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_pages_showAudio__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_pages_showAudio___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_pages_showAudio__);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    routes: [{
        ...
        path: '/audio',
        name: 'audio',
        component: __WEBPACK_IMPORTED_MODULE_3_pages_showAudio___default.a
    }]
}));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: {
    ...
    mode: {
      type: Number,
      default: __WEBPACK_IMPORTED_MODULE_0__constant__["a" /* SINGLE */]
    },
    index: {
      type: Number,
      default: 0,
  ...
  computed: {
    loop: function loop() {
      return this.mode === __WEBPACK_IMPORTED_MODULE_0__constant__["b" /* LOOP */];
    }
  },
  methods: {
    ...
    _timeupdate: function _timeupdate(e) {
      this.$emit('timeupdate', e);
    },
    _playing: function _playing(e) {
      this.$emit('playing', e);
      this._stopOther(e.target.parentElement);
    },
    _pause: function _pause(e) {
      this.$emit('pause', e);
    },
    _waiting: function _waiting(e) {
      this.$emit('waiting', e);
    },
    ...
    _modeControl: function _modeControl() {
      if (this.mode === __WEBPACK_IMPORTED_MODULE_0__constant__["a" /* SINGLE */]) {
        return;
      }
      var index = this.index;
      var nextIndex = void 0;

      if (this.mode === __WEBPACK_IMPORTED_MODULE_0__constant__["c" /* ORDER */] && index < this.audios.length - 1) {
        nextIndex = index + 1;
        this.audios[nextIndex].play();
        return;
      }

      if (this.mode === __WEBPACK_IMPORTED_MODULE_0__constant__["d" /* CIRCULATION */]) {
      ...
      if (this.mode === __WEBPACK_IMPORTED_MODULE_0__constant__["e" /* RANDOM */]) {
    ...
    _stopOther: function _stopOther(target) {
      if (currentTarget && currentTarget !== target) {
        var audio = currentTarget.querySelector('audio');
        audio.pause();
        audio.currentTime = 0;
      }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__markdown__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__markdown___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__markdown__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      code: '<pre><code><span class="hljs-tag"><span class="hljs-name">div</span></span>\n    \u6211\u662F\u4E00\u4E2Adiv\u6807\u7B7E\n<span class="hljs-tag"><span class="hljs-name">div</span></span>\n</code></pre>'
    };
  },

  components: {
    markdown: __WEBPACK_IMPORTED_MODULE_0__markdown___default.a
  }
});
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_marked__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_scroll__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__static_js_highlight_min_js__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__static_js_rangeFn_js__ = __webpack_require__(32);
...
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_2_vue_scroll___default.a);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_audio_audio_vue__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_audio_audio_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_audio_audio_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__ = __webpack_require__(2);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'showAudio',
  components: {
    myAudio: __WEBPACK_IMPORTED_MODULE_0__components_audio_audio_vue___default.a
  },
  data: function data() {
    return {
      lists: [{
      ...
      mode: __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["a" /* SINGLE */],
      single_mode: __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["a" /* SINGLE */],
      loop_mode: __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["b" /* LOOP */],
      order_mode: __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["c" /* ORDER */],
      circulation_mode: __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["d" /* CIRCULATION */],
      random_mode: __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["e" /* RANDOM */],
      svgOptions: {
        width: 40,
        height: 40,
        fill: 'none',
  ...
  methods: {
    timeupdate: function timeupdate(e) {
      ...
      var percent = (100 / duration * currentTime).toFixed(1);
      if (isNaN(percent) || percent === '0.0') {
        percent = 0;
      }
      var svg = target.parentNode.querySelector('svg');
      if (percent > 100) {
        percent = 100;
      }
      var centerX = this.svgOptions.width / 2;
      var centerY = this.svgOptions.height / 2;
      var radius = centerX - this.svgOptions.strokeWidth / 2;
      var startX = centerX;
      ...
      var endX = centerX + radius * Math.sin(circ * percent / 100);
      var endY = centerY - radius * Math.cos(circ * percent / 100);
      var d = 'M' + startX + ',' + startY + ' ' + 'A' + radius + ',' + radius + ' ' + xAxisRotation + ' ' + largeArcFlag + ' ' + sweepFlag + ' ' + endX + ',' + endY;
      var path = svg.querySelector('path');
      path.setAttribute('d', d);
    },
    playing: function playing(e) {
      e.target.parentElement.querySelector('a').className = __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["f" /* PLAY_CLASS */];
    },
    pause: function pause(e) {
      e.target.parentElement.querySelector('a').className = __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["g" /* PAUSE_CLASS */];
    },
    ended: function ended(e) {
      e.target.parentElement.querySelector('a').className = __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["g" /* PAUSE_CLASS */];
    },
    waiting: function waiting(e) {
      e.target.parentElement.querySelector('a').className = __WEBPACK_IMPORTED_MODULE_1__components_audio_constant_js__["h" /* LOAD_CLASS */];
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "vue-audio-container",
    on: {
  ...
  }, [_vm._t("default"), _vm._v(" "), _c('audio', {
    staticClass: "vue-audio",
    attrs: {
      "muted": _vm.muted,
    ...
    on: {
      "ended": _vm._ended,
      "playing": _vm._playing,
      "pause": _vm._pause,
      "error": _vm._error,
      "timeupdate": _vm._timeupdate,
      "waiting": _vm._waiting
    }
  })], 2)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('my-audio', {
      ...
      attrs: {
        "width": _vm.svgOptions.width,
        "height": _vm.svgOptions.height
      }
    }, [_c('path', {
      attrs: {
        "fill": _vm.svgOptions.fill,
        "stroke": _vm.svgOptions.stroke,
        "stroke-width": _vm.svgOptions.strokeWidth
      }
    })]), _vm._v(" "), _c('a', {
      staticClass: "play",
      attrs: {
...
//# sourceMappingURL=app.8e061b4dad4c03dfb1db.js.map